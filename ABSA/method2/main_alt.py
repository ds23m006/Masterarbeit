...
def process_documents_method2alt(collection_name, aspect="OeNB"):
    ...
    for doc in docs_list:
        ...
        #if doc.get("features", {}).get("absa", {}).get("method2alt", {}).get("overall_sentiment"):
        ...
        collection.update_one(
            {"_id": doc_id},
            {"$set": {"features.absa.method2alt.overall_sentiment": {aspect: overall_class}}}
        )
...
if __name__ == "__main__":
    ...
    for collection_name in collections:
        ...
        process_documents_method2alt(collection_name, aspect="OeNB")
